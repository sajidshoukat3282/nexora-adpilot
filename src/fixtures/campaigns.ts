...
function budget(inv: number, creative: number, addl: number, discount: number, cpm: number, currency: string = "PKR"): Campaign["budget"] {
  const total = inv + creative + addl - discount;
  return {
    inventoryCost: money(inv, currency as any),
    creativeFees: money(creative, currency as any),
    additionalFees: money(addl, currency as any),
    discount: money(discount, currency as any),
    total: money(total, currency as any),
...
export const CAMPAIGNS: Campaign[] = [
  {
    ...
    budget: budget(1950000, 85000, 20000, 60000, 1450, "PKR"),
  ...
  },
  {
    ...
    budget: budget(570000, 45000, 12000, 0, 980, "PKR"),
  ...
  },
  {
    ...
    budget: budget(930000, 60000, 15000, 40000, 1120, "PKR"),
  ...
  },
  {
    ...
    budget: budget(1260000, 95000, 18000, 80000, 1340, "PKR"),
  ...
  },
  {
    ...
    budget: budget(680000, 52000, 10000, 25000, 990, "PKR"),
  ...
  },
  {
    ...
    budget: budget(825000, 40000, 14000, 0, 1050, "USD"),
  ...
  },
  {
    ...
    budget: budget(2100000, 90000, 22000, 150000, 1280, "PKR"),
  ...
  },
  {
    ...
    budget: budget(340000, 20000, 5000, 0, 780, "PKR"),
    assetIds: [], creativeIds: [], ownerUserId: "user-cm",
  ...
  },
  {
    ...
    budget: budget(210000, 15000, 0, 0, 900, "PKR"),
    assetIds: [], creativeIds: [], ownerUserId: "user-sales",
